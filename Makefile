...
#    Updated: 2019/01/29 10:56:12 by vde-sain    ###    #+. /#+    ###.fr      #
#                                                          /                   #
#                                                         /                    #
# **************************************************************************** #
...
PRINTF_SRC = ft_printf/add_conversion.c ft_printf/add_flags.c ft_printf/conversion_type.c ft_printf/conversion_type2.c ft_printf/determ_data.c ft_printf/ft_printf.c ft_printf/handle_flags_order.c ft_printf/handle_float.c ft_printf/handle_prec_and_width.c ft_printf/others.c ft_printf/print_printf.c
